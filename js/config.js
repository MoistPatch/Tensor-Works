  ...
  products: [
    {
      ...
      specs: [
        ...
        { key: 'TF32 TFLOPS', value: '989' },
        { key: 'Form Factor', value: 'SXM5 / PCIe' },
      ],
      inStock: true,
      tags: ['GPU', 'NVIDIA', 'H100', 'Training', 'HPC'],
    },
    {
      ...
      specs: [
        { key: 'Memory', value: '141GB HBM3e' },
        { key: 'Bandwidth', value: '4.8TB/s' },
        { key: 'FP8 TFLOPS', value: '3958' },
        { key: 'Form Factor', value: 'SXM5' },
      ],
      inStock: false,
      tags: ['GPU', 'NVIDIA', 'H200', 'Training', 'HPC'],
    },
    {
    ...
    },
    {
      ...
      specs: [
        { key: 'Memory', value: '48GB GDDR6 ECC' },
        { key: 'CUDA Cores', value: '18,176' },
        { key: 'RT Cores', value: '3rd Gen' },
        { key: 'TDP', value: '300W' },
      ],
      inStock: true,
      tags: ['GPU', 'NVIDIA', 'RTX', 'Workstation', 'Visualization'],
    },
    {
      ...
      inStock: true,
      tags: ['DPU', 'NVIDIA', 'BlueField', 'Networking', 'SmartNIC'],
    },
    {
      ...
      specs: [
        { key: 'Frameworks', value: 'PyTorch, TF, JAX' },
        { key: 'Inference', value: 'Triton Server' },
        { key: 'Training', value: 'NeMo' },
        { key: 'Support', value: '24/7 Enterprise' },
      ],
      inStock: true,
      tags: ['Software', 'NVIDIA', 'AI Enterprise', 'MLOps'],
    },
    {
      ...
      inStock: true,
      tags: ['Server', 'Dell', 'PowerEdge', 'HPC', 'AI'],
    },
    {
      ...
      inStock: true,
      tags: ['Networking', 'InfiniBand', 'Mellanox', 'NDR', 'HPC'],
    },
  ],
};
