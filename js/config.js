window.TW = {
  shopify: {
    ...
    returnDomain: 'https://yourdomain.com.au',
    configured: true,
  },
  dickerData: {
  ...
  products: [
    ...
    },
    {
      ...
      "category": "Networking",
      "sku": "MLX-IB-NDR400",
      "priceDisplay": "A$6,350.00",
      "shopifyVariantId": "43751354892366",
      "image": null,
      "iconClass": "green",
      "icon": "fa-network-wired",
      "description": "The NVIDIA Quantum-2 QM9700 series is a 1U managed InfiniBand switch delivering NDR 400Gb/s connectivity for AI and HPC environments. Built on the third-generation NVIDIA Quantum-2 ASIC, the platform provides 64 ports of NDR 400Gb/s InfiniBand via 32 physical OSFP cages, with each cage supporting two NDR ports. Aggregate bidirectional switching throughput reaches 51.2 Tb/s, with the ASIC capable of more than 66.5 billion packets per second. The switch supports port splitting to NDR200 (200Gb/s), enabling up to 128 endpoints per switch for high-radix fat-tree, DragonFly+ and SlimFly topologies. In-network computing is accelerated through third-generation NVIDIA SHARP, which offloads collective operations such as all-reduce to the fabricÃ¢ÂÂmaterially improving AI training scale-out efficiency. Advanced congestion control, adaptive routing and self-healing networking reduce tail latency in large GPU clusters. For Australian enterprises deploying DGX SuperPOD, generative AI training fabrics, or traditional HPC clusters, the QM9700 provides a forward-compatible 400Gb/s backbone. The platform is offered in both externally managed and internally managed variants, ships with redundant hot-swappable power supplies and fans, and supports standard front-to-rear or rear-to-front airflow for flexible data centre integration.",
      "specs": [
        {
          "key": "Switch Silicon",
          "value": "NVIDIA Quantum-2"
        },
        {
          "key": "InfiniBand Speed",
          "value": "NDR 400Gb/s per port"
        },
        {
          "key": "Port Configuration",
          "value": "64 x NDR 400Gb/s ports via 32 OSFP cages"
        },
        {
          "key": "Maximum Endpoints (split mode)",
          "value": "Up to 128 x NDR200 200Gb/s"
        },
        {
          "key": "Aggregate Switching Capacity",
          "value": "51.2 Tb/s bidirectional"
        },
        {
          "key": "Packet Forwarding Rate",
          "value": "Over 66.5 billion packets per second"
        },
        {
          "key": "In-Network Computing",
          "value": "3rd generation NVIDIA SHARP"
        },
        {
          "key": "Connector Type",
          "value": "OSFP (32 cages)"
        ...
        {
          "key": "Form Factor",
          "value": "1U rack-mountable"
        },
        {
          "key": "Management",
          "value": "Available as externally managed or internally managed (UFM-ready)"
        },
        {
          "key": "Power Supplies",
          "value": "Dual hot-swappable redundant PSUs"
        },
        {
          "key": "Cooling",
          "value": "Hot-swappable fans; front-to-rear (P2C) or rear-to-front (C2P) airflow options"
        },
        {
          "key": "Routing Features",
          "value": "Adaptive routing, advanced congestion control, self-healing networking"
        },
        {
          "key": "Use Cases",
          "value": "AI training fabrics, DGX SuperPOD, HPC clusters"
        }
      ],
      "inStock": true,
      "tags": [
